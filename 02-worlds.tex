...
$\Diamond p \to \Box p$ is \emph{true} at some world $w$. We write this down as follows.
...
and you have added the new nodes to every open branch containing the node, 
...
a reminder that these rules can only be applied once on each open branch. If you've
...
target sentence. If there is no countermodel for a sentence, the sentence
