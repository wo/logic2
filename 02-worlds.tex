...
(un-pointed) model could be chosen as the designated world, a sentence is true at all worlds in all basic models just in case
...
\begin{proof}
  ...
  parts. The observation is vacuously true. (There is no way of turning $p$ into
  a non-equivalent sentence by replacing a subsentence within $p$.)
  ...
  our induction hypothesis) that the observation holds for the simpler
  sentences.
...
this method for non-modal logic. If so, good. If not, no problem.) It best
