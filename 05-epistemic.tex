...
But we might look at other schemas, corresponding to further conditions on the
...
\begin{quote}
  ...
  Do you know many children have mud on their face? What happens when the mother
  asks her question a third time?
\end{quote}

To answer these questions, we can begin by drawing a model. I'll call the three
children Alice, Bob, and Carol, and I'll use $m_a, m_b, m_c$ as sentence letters
expressing, respectively, that Alice/Bob/Carol is muddy; $c_a, c_b, c_c$ mean
that Alice/Bob/Carol is clean. Before the mother's first announcement, there are
eight relevant possibilities.
