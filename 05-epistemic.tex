...
but this isn't built into the essence of the person to which our concept refers.
...
\begin{definition}{Basic Two-Dimensional Semantics}{basic2dsemantics}
  If $M = \t{W,V}$ is a basic two-dimensional model, $w_{1},w_{2}$ are members of $W$, $P$ is
...
In two-dimensional modal logic,
the rule of Necessitation does not preserve validity.
