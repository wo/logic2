...
\end{exercise}
\begin{solution}
  Assume that `the die shows a 6 if it shows an even number' expresses an
  epistemically strict conditional, and our evidence is neutral on the outcome
  of the die roll. Then the epistemically strict conditional is definitely false
  (our evidence does not entail \emph{not-6 or even}): given the facts about our
  evidence, it has probability zero. But the intuitive probability is
  $\frac{1}{3}$, not 0.
\end{solution}
