...
(d) by identifying the truth-value False with the empty set $\emptyset$ and
the truth-value True with the singleton set $\{ \t{} \}$ containing the empty tuple. (Don't worry if you find this confusing or objectionable. We won't be using zero-ary predicates.)
