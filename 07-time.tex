...
% TODO: I should probably change 'right-linearity' to 'forward-linearity'.
% Mueller also uses 'right', but more people seem to use 'forward', and
% 'forward' doesn't rely on a somewhat arbitrary LTR convention for representing
% times.
